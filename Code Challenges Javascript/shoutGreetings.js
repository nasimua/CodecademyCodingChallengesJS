...
// This new array should contain all the strings from the argument array but with 
// capitalized letters and an exclamation point appended to the end: 'heya' will become 'HEYA!'
...
const shoutGreetings = string => {
    return string.map(words => words.toUpperCase() + '!')
  }
